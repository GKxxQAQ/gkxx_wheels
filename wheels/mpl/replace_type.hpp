...
namespace __details {
  ...
  template <typename C, typename X, typename Y>
  struct __replace_type_impl<C *, X, Y> {
...
template <typename C, typename X, typename Y>
struct replace_type : __details::__replace_type_impl<C, X, Y> {};
